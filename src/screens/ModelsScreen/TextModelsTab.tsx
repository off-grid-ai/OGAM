...
import { fileExceedsBudget, fitTier } from '../../services/memoryBudget';
      ...
      {isLoadingFiles ? (
        ...
        <FlatList
          data={modelFiles
            ...
            .filter(f => f.size > 0 && fitTier(f.size, ramGB) !== 'wontFit' && (filterState.quant === 'all' || f.name.includes(filterState.quant)))
            .sort((a, b) => {
